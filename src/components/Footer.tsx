        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          <div>
            ...
            <p className="font-body text-primary-foreground/70 text-sm leading-relaxed">
              Kontorslokaler och förråd i Norra Hamnen, Lysekil. Ett attraktivt läge vid havet med
              närhet till allt du behöver.
            </p>
          </div>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              <Link to="/lokaler" className="text-sm text-primary-foreground/70 hover:text-accent transition-colors font-body">
                Lokaler & Förråd
              </Link>
              <Link to="/om-oss" className="text-sm text-primary-foreground/70 hover:text-accent transition-colors font-body">
                Om Norra Magasinet
              </Link>
              <Link to="/laget" className="text-sm text-primary-foreground/70 hover:text-accent transition-colors font-body">
                Läget i Norra Hamnen
              </Link>
              <Link to="/kontakt" className="text-sm text-primary-foreground/70 hover:text-accent transition-colors font-body">
                Kontakt
              </Link>
            </nav>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-primary-foreground/70 font-body">
              <div className="flex items-start gap-2">
                ...
                <span>Norra Hamnen, Lysekil</span>
              </div>
